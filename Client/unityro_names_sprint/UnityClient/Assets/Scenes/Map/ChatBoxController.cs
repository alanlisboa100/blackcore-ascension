...
public class ChatBoxController : MonoBehaviour {
    ...
    private void OnDestroy() {
        ...
        NetworkClient.UnhookPacket(ZC.NOTIFY_PLAYERCHAT.HEADER, OnMessageRecieved);
        NetworkClient.UnhookPacket(ZC.NOTIFY_CHAT.HEADER, OnMessageRecieved);
        NetworkClient.UnhookPacket(ZC.MSG.HEADER, OnMessageRecieved);
    }
