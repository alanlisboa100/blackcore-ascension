...
public class SkillWindowController : DraggableUIWindow, ISkillWindowController {
    ...
    void Start() {
        ...
        BlackCoreWindowDecorator.Apply(gameObject, "Árvore de Poder", "Skills, evolução e caminhos de combate");
    ...
    public void UpdateSkillPoints() {
        ...
        skillPointsText.text = $"Pontos de Poder: {AvailableSkillPoints}";
    }
