...
public static class RawImageExtenions {
    ...
    public static void SetLoginBackground(this RawImage image) {
        Texture2D texture = AddressableAssetCache<Texture2D>.LoadSync($"{DBManager.INTERFACE_PATH}{LOGIN_BACKGROUND_IMAGE}");
    ...
    public static void SetLoading(this RawImage image) {
        ...
        Texture2D texture = AddressableAssetCache<Texture2D>.LoadSync($"{DBManager.INTERFACE_PATH}{imageName}");
