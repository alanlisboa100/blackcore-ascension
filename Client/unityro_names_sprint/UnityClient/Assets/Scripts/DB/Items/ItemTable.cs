    ...
    public static void LoadItemDb() {
        ...
        foreach (var key in table.Keys) {
            try {
                ...
                var itemId = int.Parse(key.ToString());
                var item = new Item() {
                    id = itemId,
                    unidentifiedDisplayName = BlackCoreLoreService.ResolveItemName(it["unidentifiedDisplayName"].ToString(), itemId),
                    unidentifiedResourceName = it["unidentifiedResourceName"].ToString(),
                    unidentifiedDescriptionName = BlackCoreLoreService.ApplyDialogueIdentity(string.Join("\n", unidentifiedDescriptionName)),
                    identifiedDisplayName = BlackCoreLoreService.ResolveItemName(it["identifiedDisplayName"].ToString(), itemId),
                    identifiedResourceName = it["identifiedResourceName"].ToString(),
                    identifiedDescriptionName = BlackCoreLoreService.ApplyDialogueIdentity(string.Join("\n", identifiedDescriptionName)),
